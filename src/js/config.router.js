...
// .state('apps.animal', {
//                   url: '/animal',
//                   templateUrl: 'tpl/apps_animales.html',
//                   resolve: {
//                       deps: ['uiLoad',
//                         function( uiLoad ){
//                           return uiLoad.load( ['js/app/animal/animal.js'] );
//                       }]
//                   }
//               })
.state('app.form.ajustes', {
...
.state('apps.socio', {
                  url: '/socio',
                  templateUrl: 'tpl/apps_socios.html',
                   resolve: {
                      deps: ['$ocLazyLoad',
                        function( $ocLazyLoad ){
                          return $ocLazyLoad.load(['ui.select','toaster']).then(
                              function(){
                                  return $ocLazyLoad.load('js/app/socio/socio.js');
                              }
                          );
                      }]
                  }
...
.state('apps.historicoAnimal', {
                  url: '/historicoAnimal',
                  templateUrl: 'tpl/apps_historicoAnimal.html',
                   resolve: {
                      deps: ['$ocLazyLoad',
                        function( $ocLazyLoad ){
                          return $ocLazyLoad.load(['ui.select','ngGrid']).then(
                              function(){
                                  return $ocLazyLoad.load('js/app/animal/historicoAnimal.js');
                              }
                          );
                      }]
                  }
                   ...
                   resolve: {
                      deps: ['$ocLazyLoad',
                        function( $ocLazyLoad ){
                          return $ocLazyLoad.load(['ui.select','ngGrid']).then(
                              function(){
                                  return $ocLazyLoad.load('js/app/animal/historicoAnimalMacho.js');
                              }
                          );
                      }]
                  }
